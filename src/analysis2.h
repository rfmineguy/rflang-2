...
void analyze2_func_call_expr  (expression_t*, chaining_ht_str_symbol_t);
...
void analyze2_arg_list        (arg_list_t*,   chaining_ht_str_symbol_t);
void analyze2_expression      (expression_t*, chaining_ht_str_symbol_t);
void analyze2_if              (if_t*,        chaining_ht_str_symbol_t);
void analyze2_while           (while_t*,      chaining_ht_str_symbol_t);
void analyze2_statement       (statement_t*,  chaining_ht_str_symbol_t);
